...
class AlgoritmoColoniaAbelhas:
    ...
    def __init__(self, tamanho_populacao, dimensoes, criterio_abandono, ciclos, limite_min, limite_max, funcao):
    ...
    def explorar_fontes_alimentacoes(self):
        ...
        fontes_selecionadas = EstrategiaSelecao.f_fitnes(self.fonte_alimentacao, self.tamanho_populacao//2, lista_fitness)
